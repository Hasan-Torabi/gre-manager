...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/gre-manager.sh)
```

Or install manually:

```bash
wget https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/gre-manager.sh -O /root/gre-manager.sh
